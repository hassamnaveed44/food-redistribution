  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F5F1E8]">
      ...
      <header className="border-b border-[#E3DBC9] bg-white px-6 py-4 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-[#B84A16] flex items-center justify-center text-white font-bold text-lg font-serif">
              F
            </div>
            <div>
      ...
      <section className="px-6 py-16 md:py-24 max-w-5xl mx-auto text-center flex flex-col items-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#EFEAE0] border border-[#E3DBC9] text-xs font-medium text-[#6B6157] mb-6">
          <ShieldCheck className="w-3.5 h-3.5 text-[#B84A16]" />
          <span>Operations-Grade Surplus Logistics Platform</span>
        </div>

        <h1 className="font-serif text-4xl md:text-6xl font-medium text-[#211D19] leading-tight mb-6 max-w-3xl">
          Redirect surplus food to verified NGOs or discounted sales in seconds.
        </h1>

        <p className="text-base md:text-lg text-[#6B6157] max-w-2xl mb-8 leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl mb-12">
          <Link href="/sign-up?role=business" className="w-full">
          ...
          <Link href="/sign-up?role=ngo" className="w-full">
          ...
          <Link href="/sign-up?role=buyer" className="w-full">
      ...
      <section id="how-it-works" className="bg-white border-t border-[#E3DBC9] py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Donate Path Card */}
            <div className="p-6 rounded-xl bg-[#F5F1E8]/60 border border-[#E3DBC9]">
